...
The original author did not inclyude the breaking change message. The correct message should be:
...
Methods getPortletSetup() and setPortletSetup() were removed.
